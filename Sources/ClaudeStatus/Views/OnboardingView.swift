...
struct OnboardingView: View {
    ...
    private var welcomeStep: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("Willkommen bei ClaudeStatus")
                .font(.title).bold()
            Text("ClaudeStatus zeigt dir in der Menüleiste, wie viel deines 5-Stunden-, 7-Tage- und Opus-Kontingents bei claude.ai bereits verbraucht ist – inkl. Forecast, Verlauf und Reset-Countdown.")
    ...
    private var pasteKeyStep: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            HStack(spacing: 6) {
                ...
                Text("Sobald du speicherst, lädt ClaudeStatus die erste Auswertung. Die Menüleisten-Anzeige aktualisiert sich automatisch.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
                    .fixedSize(horizontal: false, vertical: true)
            }
